...
== PROBLEM DESCRIPTION
In this assignment you will build and test REST API endpoints to perform CRUD operations on the database entity you created in assignment 3.

In the stater project of this assignment you are provided with two projects:

. A *dmit2015-assignment06-restapi-start* project for building REST API endpoints to perform CRUD operations on the database table you created in assignmetn 3.
...
. Copy your assignment 3 JPA entity classa and JPA repository to this project.
