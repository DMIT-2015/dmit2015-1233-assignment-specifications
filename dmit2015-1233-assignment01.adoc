...
stored in your Firebase Realtime Database.
...
| You have shown to your instructor your Http Request to perform CRUD(Create, Read All, Read One, Update, Delete) operations on the Firebase Realtime Database REST API.
